...
const typeValue = { "Full-time": "full-time", "Part-time": "part-time", Contract: "contract", Internship: "internship" };
const levelValue = { Junior: "junior", Mid: "mid", Senior: "senior", Lead: "lead" };
const modeValue = { Remote: "remote", Hybrid: "hybrid", "On-site": "onsite" };
...
const formatWorkMode = (workMode) => workMode === "onsite" ? "On-site" : workMode || "Work mode TBD";
...
const Jobs = () => {
    ...
    const toggleFilter = (items, value, setter) => {
    ...
    const FilterSidebar = () => (<div className="space-y-6">
      <div>
        <h3 className="mb-3 font-display text-sm font-semibold">Job Type</h3>
        <div className="space-y-2">{Object.keys(typeValue).map((type) => (<div key={type} className="flex items-center gap-2">
      ...
      <div>
        ...
        <div className="space-y-2">{Object.keys(levelValue).map((level) => (<div key={level} className="flex items-center gap-2">
      ...
      <div>
        ...
        <div className="space-y-2">{Object.keys(modeValue).map((mode) => (<div key={mode} className="flex items-center gap-2">
