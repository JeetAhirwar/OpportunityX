...
import { getCompanyProfile, saveCompanyProfile, submitCompanyVerification, } from "@/features/recruiter/recruiterApi";
const emptyCompany = {
...
const CompanyProfile = () => {
    ...
    if (loading)
        return <div className="flex min-h-[300px] items-center justify-center"><Loader2 className="mr-2 h-5 w-5 animate-spin"/> Loading company profile...</div>;
    if (error)
        return <div className="rounded-xl border border-destructive/30 p-6 text-sm text-destructive">{error}</div>;
