...
describe("API URL construction", () => {
    ...
    it("keeps /api in the configured base URL for production auth requests", () => {
        expect(createApiUrl(productionBaseUrl, "/auth/me")).toBe("https://opportunityx-6klo.onrender.com/api/auth/me");
    });
    it("keeps /api in the configured base URL for production jobs requests", () => {
        expect(createApiUrl(productionBaseUrl, "/jobs/featured")).toBe("https://opportunityx-6klo.onrender.com/api/jobs/featured");
    });
