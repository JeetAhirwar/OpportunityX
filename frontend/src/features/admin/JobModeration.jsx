...
const JobModeration = () => {
    ...
    const moderate = async (job, update) => {
        try {
            const updated = unwrapAdminData(await api.patch(`/admin/jobs/${job._id}/moderate`, update));
