...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn("rounded-lg border border-border/70 bg-card/80 text-card-foreground shadow-[0_16px_46px_hsl(224_48%_3%/0.18)] backdrop-blur-xl transition-colors", className)} {...props}/>));
