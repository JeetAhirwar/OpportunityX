...
const Footer = () => {
    ...
    return (<footer className="border-t border-border/70 bg-card/70 backdrop-blur-xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {[Twitter, Linkedin, Github, Mail].map((Icon, index) => (<a key={index} href="#" aria-label={`OpportunityX social link ${index + 1}`} className="flex h-9 w-9 items-center justify-center rounded-full border border-border/70 bg-secondary/70 text-muted-foreground transition-colors hover:border-primary/40 hover:bg-primary/15 hover:text-primary">
