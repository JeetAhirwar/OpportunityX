...
const JobDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title={`${job.title} at ${job.company} â€” OpportunityX`}
        description={`Apply for ${job.title} at ${job.company}. ${job.salary} Â· ${job.location}`}
        jsonLd={{
                      ...
                      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>at {job.company} Â· {job.location}</DialogDescription>
                          </DialogHeader>
                          <div className="space-y-3">
                            <p className="text-sm text-muted-foreground">Your profile and resume will be shared with the recruiter.</p>
                            <Textarea
                              placeholder="Cover letter (optional) â€” Tell the recruiter why you're a great fit..."
                              value={coverLetter}
